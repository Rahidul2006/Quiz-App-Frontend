...
import { Zap, Lock, Mail, User as UserIcon, ArrowRight, AlertCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#080c14] flex items-center justify-center p-4 relative selection:bg-emerald-500/30 selection:text-emerald-300">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-black text-white tracking-tight">Create Host Account</h2>
          <p className="text-xs text-slate-400">
            Start hosting live audience polls and quizzes today.
          </p>
        </div>
